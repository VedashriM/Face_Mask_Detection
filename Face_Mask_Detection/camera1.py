...
class VideoCamera:
    def __init__(self):
         ...
         self.video = cv2.VideoCapture(0) #'http://192.168.0.102:4747/video'

    def update(self,is_usb):
         self.video = cv2.VideoCapture(is_usb)
    ...
    def get_frame(self):
        try:
            #self.video = cv2.VideoCapture("http://192.168.0.102:4747/video")
